...
assert.ok(decisionGuide.includes('通用判断框架'))
assert.ok(decisionGuide.includes('① 看访问模式'))
assert.ok(decisionGuide.includes('② 看分布风险'))
assert.ok(decisionGuide.includes('③ 看节点余量'))
