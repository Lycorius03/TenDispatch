...
assert.ok(tutorialRouting.includes('查询条件决定要问几个 DN'))
const tutorialReady=renderToStaticMarkup(React.createElement(GamePage,{...props,state:{...createTutorialState(),screen:'game',tutorialStep:7,tutorialWaveCompleted:true}}))
assert.ok(tutorialReady.includes('准备好用状态继承冲榜'))
